...
class Goods extends Base
{
    ...
    public function getImage()
    {
        ...
        $qrcode = $this->saveQrcode($wxappId, $scene, 'pages/goods/index');
        // 拼接海报图
    ...
    private function savePoster($backdrop, $goodsUrl, $qrcode)
    {
        ...
        // 写入商品价格
        $editor->text($backdropImage, $this->goods['sku'][0]['goods_price'], 38, 62, 964, new Color('#ff4444'));
        // 打开小程序码
    ...
    private function getPosterName()
    {
        ...
        return 'goods_' . md5("{$this->goods['goods_id']}_{$this->user_id}") . '.png';
    }
    ...
    {
        return $this->posterUrl ?: (\base_url() . 'temp/' . $this->goods['wxapp_id'] . '/' . $this->getPosterName());
    }
